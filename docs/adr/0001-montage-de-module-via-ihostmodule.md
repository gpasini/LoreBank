...
> Statut : accepté — 2026-09-03 ; complété par l'ADR 0005, qui revient sur
> l'option « `Type DbContextType` générique » écartée ci-dessous, puis par
> l'ADR 0007, qui dérive les assemblies du seam depuis le DbContext.
