...
// N'hérite volontairement pas de BaseIntegrationTest : un TransactionScope interne
...
public sealed class TransactionRollbackTest
{
    ...
    public async Task OpenBankAccount_ShouldPersistNothing_WhenADomainEventHandlerThrows()
    {
        ...
        var sender = TestHost.Factory.Services.GetRequiredService<ConfigurableWelcomeLetterSender>();
        ...
        using var readScope = TestHost.Factory.Services.CreateScope();
